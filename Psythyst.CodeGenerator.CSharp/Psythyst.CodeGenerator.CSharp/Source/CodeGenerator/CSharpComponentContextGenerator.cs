...
{
    /// <summary>
    /// CSharpComponentContextGenerator Class.
    /// </summary>
    public class CSharpComponentContextGenerator : IGenerator<ProjectModel, OutputModel>
    {
...
";
        ...
        OutputModel Generate(string Context, ProjectComponentModel ProjectComponentModel) {
            ...
            var FileContent = Template
                ...
                .Replace("${MethodArgument}", GetMethodArgument(ProjectComponentModel.Attribute));
        ...
        string GetMethodArgument(ProjectComponentAttributeModel[] Attribute) {
            var args = Attribute
