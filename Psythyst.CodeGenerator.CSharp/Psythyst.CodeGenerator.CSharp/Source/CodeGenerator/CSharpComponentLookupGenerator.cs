...
{
    /// <summary>
    /// CSharpComponentLookupGenerator Class.
    /// </summary>
    public class CSharpComponentLookupGenerator : IGenerator<ProjectModel, OutputModel>
    {
...
@"        typeof(${ComponentType})";
        ...
        OutputModel Generate(string Context, IEnumerable<ProjectComponentModel> ProjectComponentModel, int Length)
        {
